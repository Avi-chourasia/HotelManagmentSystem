...
public class AddEmployee extends JFrame  implements ActionListener{
    ...
    AddEmployee(){
                ...
                String str [] = {"Front Desk Clerks","Porters","Housekeeping","Kitchen staff","Room service","Waiter/Waiterees","Manager","Accountant","Chef"};
               ...
               ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/managment/system/icon/tenth.jpg"));
